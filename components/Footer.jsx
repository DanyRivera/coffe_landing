        ...
        <footer className="bg-footer md:px-20">
            ...
            <div className="md:flex md:items-center">
                <div className="flex flex-col gap-10 px-10 pt-20">
                    <div className="flex flex-col gap-5">
                        <div className="flex items-center gap-3">
                            ...
                            <h1 className="text-white tracking-wider m-0 text-3xl font-bold">Dany Coffe</h1>
                        </div>

                        <p className="text-white leading-7 md:text-sm">Café Aura offers premium, expertly crafted coffee that delivers rich flavors and an unforgettable experience in every cup</p>
                    </div>

                    <div className="flex flex-col gap-5">

                        <p className="text-white text-xl md:text-base">Join Our Coffee Community</p>
                ...
                <div className="text-white mx-14 pb-14 flex flex-col gap-5 mt-12 md:flex-row md:gap-16 md:text-center">
                    <div>
                        <h2 className="text-xl font-bold border-b pb-1 mb-3 w-20 md:text-base">About</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold border-b pb-1 mb-3 w-28 md:text-base">Company</h2>
                        <div className="flex flex-col gap-2 md:text-sm">
                            <p>How we work</p>
                    ...
                    <div>
                        <h2 className="text-xl font-bold border-b pb-1 mb-3 w-34 md:text-base">Get in Touch</h2>
                        <div className="flex flex-col gap-2 md:text-sm">
            ...
            <div className="border-t border-white/50 mx-20 md:mt-10">
                <p className="text-white text-center py-8 md:py-4 md:text-sm">&#x2117; 2025 Dany Coffe. All rights reserved.</p>
            </div>
