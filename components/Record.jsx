...
const Footer = () => {
    return (
        <footer className="bg-footer md:px-20">
            ...
            <div className="md:flex md:items-center">
                <div className="flex flex-col gap-10 px-10 pt-20">
                    <div className="flex flex-col gap-5">
                        ...
                        <p className="text-white leading-7">Café Aura offers premium, expertly crafted coffee that delivers rich flavors and an unforgettable experience in every cup.</p>
                    </div>

                    <div className="flex flex-col gap-5">

                        <p className="text-white text-xl">Join Our Coffee Community</p>
                ...
                <div className="text-white mx-14 pb-14 flex flex-col gap-5 mt-12 md:flex-row md:gap-16 md:text-center">
                    <div>
                        <h2 className="text-xl font-bold border-b pb-1 mb-3 w-20">About</h2>
                    ...
                    <div>
                        <h2 className="text-xl font-bold border-b pb-1 mb-3 w-28">Company</h2>
                        <div className="flex flex-col gap-2">
                            <p>How we work</p>
                    ...
                    <div>
                        <h2 className="text-xl font-bold border-b pb-1 mb-3 w-34">Get in Touch</h2>
                        <div className="flex flex-col gap-2">
            ...
            <div className="border-t border-white/50 mx-10 md:mt-10">
                <p className="text-white text-center py-8">&#x2117; 2025 Dany Coffe. All rights reserved.</p>
            </div>
